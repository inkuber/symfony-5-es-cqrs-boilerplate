...
final class Item
{
    ...
    private function __construct(string $id, string $type, $payload, array $relations = [])
    {
        $this->id = $id;
        $this->type = $type;
    ...
    public static function fromPayload(string $id, string $type, $payload, array $relations = []): self
    {
        return new self(
            $id,
            $type,
